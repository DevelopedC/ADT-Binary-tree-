...
template<typename T> // predicate for elements
void ShowValue(const T& value)
{
	std::cout << value << " ";
}

template<typename T> // output of all elements
...
int main()
{
	// Constructros:
	{
		...
		BinaryTree<int> tree1;						// defualt constructor
		Show(tree1);

		BinaryTree<int> tree2{10,1,9,2,8,3};		// initializer_list constructor
		Show(tree2);
	...
	// Operators =:
	{
		...
		tree4 = std::move(tree3);  // move assigment operator
